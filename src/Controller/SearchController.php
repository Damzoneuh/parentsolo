...
class SearchController extends AbstractController
{
    ...
    public function search(Request $request, TranslatorInterface $translator, SearchService $searchService){
        ...
        $search = [];
        foreach ($userRepository->findBy(['isValidated' => true, 'isConfirmed' => true]) as $user){
            //dump($user->getProfil()->getRelation()->getId()); die();
    ...
    public function autoSearch(SearchService $searchService){
        ...
        $usersIds = $em->findBy(['isValidated' => true, 'isConfirmed' => true]);
